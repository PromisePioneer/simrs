    ...
    <section className={cn(sectionVariants({ size, theme }), className)}>
      ...
      <div className={cn("container relative", "p-0 md:p-[1rem]")}>
        <div className="mx-auto flex max-w-7xl flex-col gap-6">
          <div
            className={cn("flex flex-col gap-4", theme === "classic" && "text-center")}>
          ...
          <div
            ...
            <div
              className={cn(toggleVariants({ theme }), theme === "classic" && "mx-auto")}>
              <RadioGroup
          ...
          <div
            className="flex w-full flex-col items-stretch gap-6 md:flex-row md:items-stretch">
            {plans.map((plan, index) => (
              <motion.div
                ...
                <Badge
                  className={cn(theme === "classic" && !plan.highlight 
                  ...
                  <ul className="text-muted-foreground space-y-4">
                    {plan.features.map((feature, featureIndex) => (
                      <motion.li
                        ...
                        <span className={cn(theme === "classic" && "text-foreground/90")}>
                          {feature.name}
                        </span>
                      </motion.li>
                    ))}
