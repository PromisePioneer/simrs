        ...
        <div
          ...
          {plans.map((plan, index) => (
            <motion.div
              ...
              }), index === 0 && "md:rounded-l-xl md:border-r-0", index === plans.length - 1 && "md:rounded-r-xl md:border-l-0", index > 0 && index < plans.length - 1 && "md:border-l-0 md:border-r-0", plans.length === 1 && "rounded-xl")}
              initial={{ opacity: 0 }}
              whileInView={{ opacity: 1 }}
              viewport={{ once: true }}
              ...
              <div
                ...
                <div className="flex items-center gap-2 justify-center">
                  <div
                    className={cn("leading-none font-semibold", theme === "classic" && "text-lg font-bold")}>
                    {plan.title}
                  </div>
                </div>
                <p
            ...
            <TableHeader>
              <TableRow className={cn(theme === "classic" && "border-border/30")}>
                ...
                {plans.map((plan) => (
                  <TableHead
                    key={plan.id}
                    className={cn("text-center font-bold text-primary", theme === "classic" && "text-lg")}>
                    {plan.title}
                  </TableHead>
                ))}
              </TableRow>
            ...
            <TableBody>
              {(() => {
                ...
                return Array.from(allFeatures).map((featureName, featureIndex) => (
                  <TableRow
                    key={featureIndex}
                    className={cn(theme === "classic" && "border-border/20 hover:bg-muted/30")}>
                    <TableCell
                      className={cn(
