...
export const MedicineWarehouseDeleteModalContent = ({medicineWarehouseValue, selectedIds, medicineWarehouses}) => {
    return (
            ...
            <div className="bg-destructive/10 border border-destructive/20 rounded-lg p-4">
                <div className="flex gap-3">
                    ...
                    <div className="flex-1 space-y-1">
                        ...
                        {medicineWarehouseValue && selectedIds.length <= 1 ? (
                            <p className="text-sm text-muted-foreground">
                                Anda akan menghapus poli: <span
                                className="font-semibold text-foreground">{medicineWarehouseValue?.name}</span>
                            </p>
                        ) : (
