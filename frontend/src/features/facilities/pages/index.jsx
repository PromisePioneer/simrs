...
function FacilityPage({children}) {
    ...
    const menuItems = [
        {
            ...
            icon: Building2,
            description: "Kelola Fasilitas Rawat Inap",
            permission: hasPermission(PERMISSIONS.BUILDING.VIEW),
        },
    ];
    ...
    const isMainSettingsPage = location.pathname === '/profiles';
