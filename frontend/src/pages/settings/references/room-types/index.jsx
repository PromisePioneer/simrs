        ...
        <>
            ...
            <DataTable
                ...
                pagination={roomTypes ? {
                    from: roomTypes.meta?.from, to: roomTypes.meta?.to, total: roomTypes.meta?.total,
                    current_page: roomTypes.meta?.current_page, last_page: roomTypes.meta?.last_page
                } : null}
                    ...
                    <div className="bg-destructive/10 border border-destructive/20 rounded-lg p-4">
                        <div className="flex gap-3">
                            ...
                            <div className="flex-1 space-y-1">
                                ...
                                <p className="text-sm text-muted-foreground">Anda akan menghapus Tipe Ruangan: <span
                                    className="font-semibold text-foreground">{roomTypeValue?.name}</span></p>
                            </div>
                        </div>
                    </div>
                </div>
