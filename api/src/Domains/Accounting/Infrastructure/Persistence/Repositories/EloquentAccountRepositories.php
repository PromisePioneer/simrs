...
class EloquentAccountCategoryRepository extends BaseEloquentRepository
{
    public function __construct() { parent::__construct(new AccountCategoryModel()); }
...
{
    public function __construct() { parent::__construct(new AccountModel()); }
